...
{
    /// <summary>
    /// Bamboo command to create a course entity in the persistence set
    /// </summary>
    [Serializable]
    class CreateCourse : ICommand
    {
        private Course _Instance = null;

        public CreateCourse(Course Instance)
        {
        ...
        {
            (system as PersistenceSet).Courses.Add(_Instance);
            return _Instance;
        }
