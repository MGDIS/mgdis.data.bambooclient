...
{
    /// <summary>
    /// Bamboo command to create a teacher entity in the persistence set
    /// </summary>
    [Serializable]
    class CreateTeacher : ICommand
    {
        private Teacher _Instance = null;
        ...
        {
            (system as PersistenceSet).Teachers.Add(_Instance);
            return _Instance;
        }
